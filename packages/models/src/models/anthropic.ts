...
export const anthropicModels = [
	{
		...
		providers: [
			...
			},
			{
				...
				externalId: "anthropic.claude-fable-5",
				inputPrice: "10.0e-6",
				outputPrice: "50.0e-6",
				cachedInputPrice: "1.0e-6",
				cacheWriteInputPrice: "12.5e-6",
		...
		providers: [
			{
				...
				deactivatedAt: new Date("2026-07-07"),
				inputPrice: "3.0e-6",
				outputPrice: "15.0e-6",
	...
	},
	{
		...
		description:
			"Claude Sonnet 4.6 with advanced reasoning, extended thinking, and vision capabilities.",
		family: "anthropic",
	...
	},
	{
		...
		description:
			"Claude Sonnet 5 with advanced reasoning, adaptive thinking, and vision capabilities.",
		family: "anthropic",
		...
		providers: [
			{
				...
				vision: true,
				tools: true,
				deprecatedAt: new Date("2025-07-14"),
				deactivatedAt: new Date("2025-10-14"),
			},
		],
	},
	{
